  ...
  return (
    <>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            ...
            {(valid) && <button className='login' onClick={()=>(window.alert("logged out, redirecting to home page"),sessionStorage.removeItem("token"),window.sessionStorage.clear(), setValid(false),navigate('/'))} >
                Log out
            </button> }
        </div>
        </nav>
