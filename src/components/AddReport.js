...
function AddReport({valid,setValid}) {
    ...
    const handleReport = async (e)=>{
        ...
        const response1= await fetch("http://localhost:5000/findNumber",{
            method:"POST",
            headers:{
        ...
        if(json1.status===true){
            const number=json1.response[0].MOBILE;
            ...
            window.alert("This Employee ID does'nt exist");
            return;
        }
